...
interface TestMarksViewModalProps {
...
export default function TestMarksViewModal({ testMark, isOpen, onClose, onEdit, onDelete }: TestMarksViewModalProps) {
	...
	return (
		<Modal isOpen={isOpen} onClose={onClose} title="Test Mark Details" size="xl">
			<div className="space-y-6">
				{/* Header */}
				<div className="flex items-center justify-between pb-4 border-b border-gray-200">
					<div>
						<h2 className="text-2xl font-bold text-gray-900">Test Mark Record</h2>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					...
					<div>
						<label className="block text-sm font-medium text-gray-500 mb-1">Test Mark</label>
						<p className="text-lg font-bold text-primary-600">
							{testMark.test_mark !== null && testMark.test_mark !== undefined 
								? Number(testMark.test_mark).toFixed(1) 
								: '0.0'}
						</p>
					</div>
					...
					<div>
						...
						<p className="text-lg text-gray-900">
							{testMark.test_avg_mark !== null && testMark.test_avg_mark !== undefined 
								? Number(testMark.test_avg_mark).toFixed(1) 
								: 'N/A'}
						</p>
					</div>
